    ...
    <>
      <div className="page-header " filter-color="blue">
        <div
          ...
          style={{
            backgroundImage:
              "url(" + require("../../../styles/img/bg-image4.jpeg") + ")",
          }}
          ref={pageHeader}
        ></div>
        <Container>
          <div className="content-center brand">
            <img
              alt="..."
              className="n-logo"
              src={require("../../../styles/img/eagle3.png")}
            ...
            >
              ...
              <br />
              <span>저는 </span>
              <span className="text-warning">지현종</span>
              <span>입니다.</span>
            </h1>
          ...
          <h6 className="category category-absolute">
            Created by Jay - Gachon University / Computer Engineering
